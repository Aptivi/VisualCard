...
namespace VisualCard.Parts.Implementations
{
    ...
    public class ContactUriInfo : BaseCardPartInfo, IEquatable<ContactUriInfo>
    {
        ...
        internal static BaseCardPartInfo FromStringVcardStatic(string value, ArgumentInfo[] finalArgs, int altId, string[] elementTypes, string group, string valueType, Version cardVersion) =>
            new ContactUriInfo().FromStringVcardInternal(value, finalArgs, altId, elementTypes, group, valueType, cardVersion);
        ...
        internal override BaseCardPartInfo FromStringVcardInternal(string value, ArgumentInfo[] finalArgs, int altId, string[] elementTypes, string group, string valueType, Version cardVersion)
        {
            ...
            // Populate the fields
            ContactUriInfo _source = new(altId, finalArgs, elementTypes, valueType, group, value);
            return _source;
        }
        ...
        internal ContactUriInfo(int altId, ArgumentInfo[] arguments, string[] elementTypes, string valueType, string group, string source) :
