...
namespace VisualCard.Parts.Implementations
{
    ...
    public class AddressInfo : BaseCardPartInfo, IEquatable<AddressInfo>
    {
        ...
        internal override BaseCardPartInfo FromStringVcardInternal(string value, string[] finalArgs, int altId, string[] elementTypes, string group, string valueType, Version cardVersion)
        {
            ...
            AddressInfo _address = new(altId, finalArgs, _addressTypes, valueType, group, _addressPOBox, _addressExtended, _addressStreet, _addressLocality, _addressRegion, _addressPostalCode, _addressCountry);
            return _address;
        }
