...
namespace VisualCard.Calendar.Parts
{
    ...
    /// </summary>
    [DebuggerDisplay("vCalendar timezone version {CalendarVersion.ToString()}, parts: (A [{partsArray.Count}] | S [{strings.Count}] | I [{integers.Count}])")]
    public class CalendarTimeZone : Calendar, IEquatable<CalendarTimeZone>
    {
        ...
        public override TPart[] GetPartsArray<TPart>()
        {
            ...
            var key = VCalendarParserTools.GetPartsArrayEnumFromType(typeof(TPart), VCalendarConstants._objectVTimeZoneSpecifier, CalendarVersion, GetType());
        ...
        public override BaseCalendarPartInfo[] GetPartsArray(CalendarPartsArrayEnum key)
        {
            ...
            var partType = VCalendarParserTools.GetPartType(prefix, "", CalendarVersion, typeof(CalendarTimeZone));
        ...
        public override string SaveToString() =>
            SaveToString(CalendarVersion, partsArray, strings, integers, VCalendarConstants._objectVTimeZoneSpecifier);
        ...
        internal override void AddPartToArray(CalendarPartsArrayEnum key, BaseCalendarPartInfo value) =>
            AddPartToArray(key, value, CalendarVersion, partsArray, VCalendarConstants._objectVTimeZoneSpecifier);

        internal override void AddString(CalendarStringsEnum key, CalendarValueInfo<string> value) =>
            AddString(key, value, CalendarVersion, strings, VCalendarConstants._objectVTimeZoneSpecifier);

        internal override void AddInteger(CalendarIntegersEnum key, CalendarValueInfo<double> value) =>
            AddInteger(key, value, CalendarVersion, integers, VCalendarConstants._objectVTimeZoneSpecifier);
