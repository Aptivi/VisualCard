...
namespace VisualCard.Calendar.Parts
{
    ...
    public class CalendarJournal : Calendar, IEquatable<CalendarJournal>
    {
        ...
        public override TPart[] GetPartsArray<TPart>()
        {
            ...
            var key = VCalendarParserTools.GetPartsArrayEnumFromType(typeof(TPart), VCalendarConstants._objectVJournalSpecifier, CalendarVersion, GetType());
        ...
        internal override void AddPartToArray(CalendarPartsArrayEnum key, BaseCalendarPartInfo value) =>
            AddPartToArray(key, value, CalendarVersion, partsArray, VCalendarConstants._objectVJournalSpecifier);

        internal override void AddString(CalendarStringsEnum key, CalendarValueInfo<string> value) =>
            AddString(key, value, CalendarVersion, strings, VCalendarConstants._objectVJournalSpecifier);

        internal override void AddInteger(CalendarIntegersEnum key, CalendarValueInfo<double> value) =>
            AddInteger(key, value, CalendarVersion, integers, VCalendarConstants._objectVJournalSpecifier);
