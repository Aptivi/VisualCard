...
namespace VisualCard.Calendar.Parts
{
    ...
    public class CalendarDaylight : Calendar, IEquatable<CalendarDaylight>
    {
        ...
        public override TPart[] GetPartsArray<TPart>()
        {
            ...
            var key = VCalendarParserTools.GetPartsArrayEnumFromType(typeof(TPart), VCalendarConstants._objectVDaylightSpecifier, CalendarVersion, GetType());
        ...
        internal override void AddString(CalendarStringsEnum key, CalendarValueInfo<string> value) =>
            AddString(key, value, CalendarVersion, strings, VCalendarConstants._objectVDaylightSpecifier);

        internal override void AddInteger(CalendarIntegersEnum key, CalendarValueInfo<double> value) =>
            AddInteger(key, value, CalendarVersion, integers, VCalendarConstants._objectVDaylightSpecifier);
