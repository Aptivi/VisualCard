...
namespace VisualCard.Calendar.Parts.Implementations.Legacy
{
    ...
    public class ProcedureAlarmInfo : BaseCalendarPartInfo, IEquatable<ProcedureAlarmInfo>
    {
        ...
        internal static BaseCalendarPartInfo FromStringVcalendarStatic(string value, ArgumentInfo[] finalArgs, string[] elementTypes, string group, string valueType, Version calendarVersion) =>
            new ProcedureAlarmInfo().FromStringVcalendarInternal(value, finalArgs, elementTypes, group, valueType, calendarVersion);
        ...
        internal override BaseCalendarPartInfo FromStringVcalendarInternal(string value, ArgumentInfo[] finalArgs, string[] elementTypes, string group, string valueType, Version calendarVersion)
        {
            ...
            // Populate the fields
            ProcedureAlarmInfo info = new(finalArgs, elementTypes, group, valueType, runTime, snoozeTime, repeat, procedure);
            return info;
        }
        ...
        internal ProcedureAlarmInfo(ArgumentInfo[] arguments, string[] elementTypes, string group, string valueType, DateTimeOffset runTime, string snoozeTime, int repeat, string procedure) :
