...
namespace VisualCard.Calendar.Parts
{
    ...
    /// </summary>
    [DebuggerDisplay("vCalendar standard time version {CalendarVersion.ToString()}, parts: (A [{partsArray.Count}] | S [{strings.Count}] | I [{integers.Count} | E [{extraParts.Count}])")]
    public class CalendarStandard : Calendar, IEquatable<CalendarStandard>
    {
        ...
        public override BaseCalendarPartInfo[] GetPartsArray(CalendarPartsArrayEnum key)
        {
            ...
            var partType = VCalendarParserTools.GetPartType(prefix, CalendarVersion, typeof(CalendarStandard));
            if (partType.enumType is null)
                throw new ArgumentException($"Enumeration type is not found for {key}");
        ...
        /// <summary>
        /// Saves this parsed calendar standard info to the string
        /// </summary>
        ...
        public override string SaveToString(bool validate = false) =>
            SaveToString(CalendarVersion, extraParts, partsArray, strings, integers, VCalendarConstants._objectVStandardSpecifier, validate);

        /// <summary>
        /// Saves the calendar standard info to the returned string
        /// </summary>
        ...
        /// <summary>
        /// Makes an empty calendar standard info
        /// </summary>
        /// <param name="version">vCalendar version to use</param>
        /// <exception cref="ArgumentException"></exception>
        public CalendarStandard(Version version) :
            base(version)
        {
