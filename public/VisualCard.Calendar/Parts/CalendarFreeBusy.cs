...
namespace VisualCard.Calendar.Parts
{
    ...
    public class CalendarFreeBusy : Calendar, IEquatable<CalendarFreeBusy>
    {
        ...
        /// <summary>
        /// Saves this parsed calendar free/busy info to the string
        /// </summary>
        ...
        public override string SaveToString(bool validate = false) =>
            SaveToString(CalendarVersion, extraParts, partsArray, strings, integers, VCalendarConstants._objectVFreeBusySpecifier, validate);

        /// <summary>
        /// Saves the calendar free/busy info to the returned string
        /// </summary>
