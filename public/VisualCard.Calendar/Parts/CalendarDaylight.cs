...
namespace VisualCard.Calendar.Parts
{
    ...
    /// </summary>
    [DebuggerDisplay("vCalendar daylight time version {CalendarVersion.ToString()}, parts: (A [{partsArray.Count}] | S [{strings.Count}] | I [{integers.Count} | E [{extraParts.Count}])")]
    public class CalendarDaylight : Calendar, IEquatable<CalendarDaylight>
    {
        ...
        /// <summary>
        /// Saves this parsed calendar daylight info to the string
        /// </summary>
        ...
        public override string SaveToString(bool validate = false) =>
            SaveToString(CalendarVersion, extraParts, partsArray, strings, integers, VCalendarConstants._objectVDaylightSpecifier, validate);

        /// <summary>
        /// Saves the calendar daylight info to the returned string
        /// </summary>
        ...
        /// <summary>
        /// Makes an empty calendar daylight info
        /// </summary>
        /// <param name="version">vCalendar version to use</param>
        /// <exception cref="ArgumentException"></exception>
        public CalendarDaylight(Version version) :
            base(version)
        {
