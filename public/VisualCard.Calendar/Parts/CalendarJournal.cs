...
namespace VisualCard.Calendar.Parts
{
    ...
    /// </summary>
    [DebuggerDisplay("vCalendar journal version {CalendarVersion.ToString()}, parts: (A [{partsArray.Count}] | S [{strings.Count}] | I [{integers.Count} | E [{extraParts.Count}])")]
    public class CalendarJournal : Calendar, IEquatable<CalendarJournal>
    {
        ...
        public override BaseCalendarPartInfo[] GetPartsArray(CalendarPartsArrayEnum key)
        {
            ...
            var partType = VCalendarParserTools.GetPartType(prefix, CalendarVersion, typeof(CalendarJournal));
            if (partType.enumType is null)
                throw new ArgumentException($"Enumeration type is not found for {key}");
        ...
        /// <summary>
        /// Saves this parsed calendar journal to the string
        /// </summary>
        ...
        public override string SaveToString(bool validate = false) =>
            SaveToString(CalendarVersion, extraParts, partsArray, strings, integers, VCalendarConstants._objectVJournalSpecifier, validate);

        /// <summary>
        /// Saves the calendar journal to the returned string
        /// </summary>
        ...
        public bool Equals(CalendarJournal other) =>
            Equals(this, other);
        ...
        /// <returns>True if all the card elements are equal. Otherwise, false.</returns>
        public bool Equals(CalendarJournal source, CalendarJournal target)
        {
        ...
        /// <inheritdoc/>
        public static bool operator ==(CalendarJournal a, CalendarJournal b)
            => a.Equals(b);
        ...
        /// <summary>
        /// Makes an empty calendar journal
        /// </summary>
        /// <param name="version">vCalendar version to use</param>
        /// <exception cref="ArgumentException"></exception>
        public CalendarJournal(Version version) :
            base(version)
        {
