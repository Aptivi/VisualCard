...
{
    internal class VCalendarPartType
    {
        ...
        internal readonly Func<string, PropertyInfo, int, string[], Version, BaseCalendarPartInfo>? fromStringFunc;
