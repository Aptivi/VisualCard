...
namespace VisualCard.Calendar.Parsers
{
    internal class VCalendarParserTools
    {
        ...
        internal static VCalendarPartType GetPartType(string prefix, Version calendarVersion, Type componentType)
        {
            ...
            {
                VCalendarConstants._attachSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.Attach, PartCardinality.Any, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal), typeof(CalendarAlarm)), typeof(AttachInfo), AttachInfo.FromStringVcalendarStatic, "", "", "uri", [], []),
                VCalendarConstants._categoriesSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.Categories, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal)), typeof(CategoriesInfo), CategoriesInfo.FromStringVcalendarStatic, "", "", "text", [], []),
                VCalendarConstants._geoSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.Geography, PartCardinality.Any, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo)), typeof(GeoInfo), GeoInfo.FromStringVcalendarStatic, "", "", "float", [], []),
                VCalendarConstants._resourcesSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.Resources, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo)), typeof(ResourcesInfo), ResourcesInfo.FromStringVcalendarStatic, "", "", "text", [], []),
                VCalendarConstants._createdSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DateCreated, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal)), typeof(DateCreatedInfo), DateCreatedInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._created1Specifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DateCreatedAlt, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo)), typeof(DateCreatedInfo), DateCreatedInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._dateStartSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DateStart, PartCardinality.ShouldBeOne, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarFreeBusy), typeof(CalendarStandard), typeof(CalendarDaylight)), typeof(DateStartInfo), DateStartInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._dateEndSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DateEnd, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarFreeBusy)), typeof(DateEndInfo), DateEndInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._dateCompletedSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DateCompleted, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarTodo)), typeof(DateCompletedInfo), DateCompletedInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._dueDateSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DueDate, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarTodo)), typeof(DueDateInfo), DueDateInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._dateStampSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DateStamp, PartCardinality.MayBeOne, (ver) => ver.Major == 2 && TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal), typeof(CalendarFreeBusy)), typeof(DateStampInfo), DateStampInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._tzOffsetFromSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.TimeZoneOffsetFrom, PartCardinality.MayBeOne, (ver) => ver.Major == 2 && TypeMatch(componentType, typeof(CalendarStandard), typeof(CalendarDaylight)), typeof(TimeZoneOffsetFromInfo), TimeZoneOffsetFromInfo.FromStringVcalendarStatic, "", "", "utc-offset", [], []),
                VCalendarConstants._tzOffsetToSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.TimeZoneOffsetTo, PartCardinality.MayBeOne, (ver) => ver.Major == 2 && TypeMatch(componentType, typeof(CalendarStandard), typeof(CalendarDaylight)), typeof(TimeZoneOffsetToInfo), TimeZoneOffsetToInfo.FromStringVcalendarStatic, "", "", "utc-offset", [], []),
                VCalendarConstants._recDateSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.RecDate, PartCardinality.Any, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal), typeof(CalendarStandard), typeof(CalendarDaylight)), typeof(RecDateInfo), RecDateInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._exDateSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.ExDate, PartCardinality.Any, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal), typeof(CalendarStandard), typeof(CalendarDaylight)), typeof(ExDateInfo), ExDateInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._daylightSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.Daylight, PartCardinality.MayBeOne, (ver) => ver.Major == 1 && TypeMatch(componentType, typeof(Parts.Calendar)), typeof(DaylightInfo), DaylightInfo.FromStringVcalendarStatic, "", "", "text", [], []),
                VCalendarConstants._aAlarmSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.AudioAlarm, PartCardinality.Any, (ver) => ver.Major == 1 && TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo)), typeof(AudioAlarmInfo), AudioAlarmInfo.FromStringVcalendarStatic, "PCM", "", "text", ["PCM", "WAVE", "AIFF"], []),
                VCalendarConstants._dAlarmSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.DisplayAlarm, PartCardinality.Any, (ver) => ver.Major == 1 && TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo)), typeof(DisplayAlarmInfo), DisplayAlarmInfo.FromStringVcalendarStatic, "", "", "text", [], []),
                VCalendarConstants._mAlarmSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.MailAlarm, PartCardinality.Any, (ver) => ver.Major == 1 && TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo)), typeof(MailAlarmInfo), MailAlarmInfo.FromStringVcalendarStatic, "", "", "text", [], []),
                VCalendarConstants._pAlarmSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.ProcedureAlarm, PartCardinality.Any, (ver) => ver.Major == 1 && TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo)), typeof(ProcedureAlarmInfo), ProcedureAlarmInfo.FromStringVcalendarStatic, "", "", "text", [], []),
                VCalendarConstants._lastModSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.LastModified, PartCardinality.MayBeOne, (_) => TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal), typeof(CalendarTimeZone)), typeof(LastModifiedInfo), LastModifiedInfo.FromStringVcalendarStatic, "", "", "date-time", [], []),
                VCalendarConstants._freeBusySpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.FreeBusy, PartCardinality.Any, (ver) => ver.Major == 2 && TypeMatch(componentType, typeof(CalendarFreeBusy)), typeof(CalendarFreeBusyInfo), CalendarFreeBusyInfo.FromStringVcalendarStatic, "", "", "period", [], []),
                VCalendarConstants._requestStatusSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.RequestStatus, PartCardinality.Any, (ver) => ver.Major == 2 && TypeMatch(componentType, typeof(CalendarEvent), typeof(CalendarTodo), typeof(CalendarJournal), typeof(CalendarFreeBusy)), typeof(RequestStatusInfo), RequestStatusInfo.FromStringVcalendarStatic, "", "", "text", [], []),
                ...
                // Extensions are allowed
                VcardConstants._xSpecifier => new(PartType.PartsArray, CalendarPartsArrayEnum.NonstandardNames, PartCardinality.Any, null, typeof(XNameInfo), XNameInfo.FromStringVcalendarStatic, "", "", "", [], []),
